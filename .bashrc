...
alias gmail="$BROWSER --window --user \$(mhng-pipe-imap_account_name) -- \"https://mail.google.com/mail/u/0/#search/rfc822msgid=\$(mhng-pipe-header message-id | sed 's/<\(.*\)>/\1/' | sed 's/\+/%2B/g' | sed 's@/@%2F@g')\""
...
alias blu="$BROWSER --user palmer@dabbelt.com https://www.bikelaneuprising.com/submit"
